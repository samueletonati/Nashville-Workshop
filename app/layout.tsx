    ...
    <html lang="en">
      <body className={inter.className}>
        ...
        <nav className="bg-slate-900 text-white py-4 sticky top-0 z-50 shadow-md">
          <div className="max-w-5xl mx-auto px-6 flex flex-wrap gap-6 text-sm font-medium">
            <a href="#home" className="hover:text-blue-300 transition-colors">Home</a>
            <a href="#description" className="hover:text-blue-300 transition-colors">Description</a>
            <a href="#participants" className="hover:text-blue-300 transition-colors">Participants</a>
            <a href="#venue" className="hover:text-blue-300 transition-colors">Venue & Links</a>
          </div>
        </nav>
