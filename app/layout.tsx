        ...
        <footer className="border-t border-gray-200 bg-gray-50 py-5">
          <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-5 opacity-80 hover:opacity-100 transition-opacity duration-300">
              ...
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/inside-logo.png" alt="InsIDE Logo" className="h-12 w-auto object-contain" />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/dde-logo.png" alt="DDE Logo" className="h-12 w-auto object-contain" />
            </div>
